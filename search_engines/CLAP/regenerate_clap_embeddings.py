...
NOTA: importa el extractor de backend/clap_recommender.py a propósito —
los embeddings de la base de datos DEBEN salir de la misma función que
genera el embedding del query en producción (regla de consistencia).
No usar modelo_ml.py / export_embeddings_json.py para regenerar la BD:
son el prototipo original y una segunda implementación puede divergir.
"""
...
# clap_recommender.py (el motor de producción) vive en backend/
