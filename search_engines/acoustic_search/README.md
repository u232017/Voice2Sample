# Voice2Sample — Búsqueda acústica: Entrenamiento e Inferencia de Modelos KNN

## 📋 Descripción General

**`acoustic_search/`** es el módulo de **entrenamiento e inferencia** que implementa un motor de búsqueda por similitud de audio basado en descriptores de **ritmo, melodía y timbre**. Utiliza **cuatro modelos KNN independientes** (uno por cada categoría y uno combinado) para permitir búsquedas flexibles y multimodales.
...
#### **Paso 2: Navegar a la Carpeta acoustic_search**

```bash
# Navegar a search_engines/acoustic_search
cd search_engines/acoustic_search
...
Desde la carpeta `search_engines/acoustic_search` con el entorno activado:
