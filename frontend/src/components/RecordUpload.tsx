...
const recommendationModels: Array<{
  ...
  { value: 'acoustic', title: 'Acoustic Search', summary: 'Descriptor-based matching' },
...
export function RecordUpload() {
  ...
  const [recommendationModel, setRecommendationModel] =
    useState<RecommendationModel>('acoustic');
  ...
  const activeModeLabel =
    recommendationModel === 'acoustic'
      ? `Acoustic Search / ${activeFocusOption?.label || 'General'}`
      : 'CLAP / Global';
  ...
  const buildSearchRequest = (focus: SimilarityFocus) => {
    ...
    return {
      query:
        recommendationModel === 'acoustic' && analysis
  ...
  return (
    <section className="app-page studio-page">
      ...
      {mapResults && recommendationModel === 'acoustic' && (
        <SoundMap
          data={mapResults}
